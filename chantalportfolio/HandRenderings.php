		...
		<div class="container">
			...
			<div class="sixteen columns">
				...
				<div class="cycle-slider">
					<ul>
						<li><img src="images/HandRendering/OfficeRendering.jpg" alt="" /></li>
						<li><img src="images/HandRendering/MagazineRendering.jpg" alt="" /></li>
					</ul>			
				</div><!--/ .cycle-slider-->	

				<p>
					The goal for these assignments was to replicate an image selected from a book or magazine. Colour pencils and markers were used for these renderings. 
				</p>	
			...
			<section class="recent-projects">
					...
					<div class="project-thumb">
						...
						<a href="gallery-single.php" class="project-meta">
